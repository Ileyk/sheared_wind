...
\end{itemize}
In the two isothermal cases, the cooling prescription means that the flow evolution is fully adiabatic until it reaches the temperature $T_0=C$ when it becomes isothermal. The four models (fully adiabatic, high entropy, isothermal hot and cold) are summarized in Table\,\ref{tab:cool}.
