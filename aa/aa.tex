...
In the HS case, the front shock holds. In the isentropic case, the hull of the shock remains essentially unchanged, including the density XXX hump / renflement / bourrelet XXX, since the prescription is only triggered in the innermost region, where the temperature of the flow goes beyond $T_0\sim 1$MK. There, we do observe the formation of a flattened structure which presents persistent orbits. Similarly, this disc-like structure appears in the two isothermal cases, albeit thinner. The thickness of the disc correlates positively with its temperature. 
