...
In Supergiant X-ray binaries, a compact object accretes a fraction of the intense wind from an O/B supergiant companion star on a close orbit. Proxies exist to evaluate the efficiency of wind accretion, in terms of mass and angular momentum accretion rates, but they depend so dramatically on the wind speed that within the current uncertainty range, they only bring loose constrains. Furthermore, their underlying assumptions bypass the impact of orbital and dissipative effects on the flow structure as it travels from the stellar surface down to the compact accretor. The compelling need for a more comprehensive description of mass transfer through wind accretion.
